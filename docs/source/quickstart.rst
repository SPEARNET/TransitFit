...
Output files
    ...
    * ``results_with_asymmetric_errors.csv`` - This contains different upper and lower bound of errors on the best fit values. It is recommended to use these results as it handles the asymmetric distribution of sampled parameters parameters. We define upper limit on the best fit value as the 68.27 quantile of the samples beyond the best fit value, and the lower limit as 31.73 quantile of samples below the best fit.
